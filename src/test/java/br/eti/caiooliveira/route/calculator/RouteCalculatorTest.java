...
public class RouteCalculatorTest {
	...
	public void test_calculate_totals_avoiding_default(){
		...
		RouteTotals calculateTotals = RouteCalculator.Builder.create()
													 .build()
													 .calculateTotals(addresses);
		
		Assert.assertNotNull(calculateTotals);
		Assert.assertNotNull(calculateTotals.getTotalCost());
		Assert.assertNotNull(calculateTotals.getTotalDistance());
		Assert.assertNotNull(calculateTotals.getTotalFuelCost());
		Assert.assertNotNull(calculateTotals.getTotalTime());
	}
	...
	public void test_calculate_totals_custom_token(){
		...
		RouteTotals calculateTotals = RouteCalculator.Builder.create(new RouteCalculatorConfig(token))
													 .build()
													 .calculateTotals(addresses);
